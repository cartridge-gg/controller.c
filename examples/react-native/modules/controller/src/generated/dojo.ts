...
/**
 * Generated factory for {@link SearchField} record objects.
 */
export const SearchField = (() => {
    const defaults = () => ({
    });
    const create = (() => {
        return uniffiCreateRecord<SearchField, ReturnType<typeof defaults>>(defaults);
    })();
    return Object.freeze({
        /**
         * Create a frozen instance of {@link SearchField}, with defaults specified
         * in Rust, in the {@link dojo} crate.
         */
        create,
         ...
         * Defaults specified in the {@link dojo} crate.
         */
        defaults: () => Object.freeze(defaults()) as Partial<SearchField>,
    });
})();

const FfiConverterTypeSearchField = (() => {
    type TypeName = SearchField;
    class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
        read(from: RustBuffer): TypeName {
            return {
...
export type SearchMatch = {
    ...
    score: /*f64*/number | undefined
}

/**
 * Generated factory for {@link SearchMatch} record objects.
 */
export const SearchMatch = (() => {
    const defaults = () => ({
    });
    const create = (() => {
        return uniffiCreateRecord<SearchMatch, ReturnType<typeof defaults>>(defaults);
    })();
    return Object.freeze({
        /**
         * Create a frozen instance of {@link SearchMatch}, with defaults specified
         * in Rust, in the {@link dojo} crate.
         */
        create,
         ...
         * Defaults specified in the {@link dojo} crate.
         */
        defaults: () => Object.freeze(defaults()) as Partial<SearchMatch>,
    });
})();

const FfiConverterTypeSearchMatch = (() => {
    type TypeName = SearchMatch;
    class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
        read(from: RustBuffer): TypeName {
            return {
                id: FfiConverterString.read(from), 
                fields: FfiConverterArrayTypeSearchField.read(from), 
                score: FfiConverterOptionalFloat64.read(from)
            };
        }
        write(value: TypeName, into: RustBuffer): void {
            FfiConverterString.write(value.id, into);
            FfiConverterArrayTypeSearchField.write(value.fields, into);
            FfiConverterOptionalFloat64.write(value.score, into);
        }
        allocationSize(value: TypeName): number {
            return FfiConverterString.allocationSize(value.id) + 
            FfiConverterArrayTypeSearchField.allocationSize(value.fields) + 
...
/**
 * Generated factory for {@link SearchQuery} record objects.
 */
export const SearchQuery = (() => {
    const defaults = () => ({
    });
    const create = (() => {
        return uniffiCreateRecord<SearchQuery, ReturnType<typeof defaults>>(defaults);
    })();
    return Object.freeze({
        /**
         * Create a frozen instance of {@link SearchQuery}, with defaults specified
         * in Rust, in the {@link dojo} crate.
         */
        create,
         ...
         * Defaults specified in the {@link dojo} crate.
         */
        defaults: () => Object.freeze(defaults()) as Partial<SearchQuery>,
    });
})();

const FfiConverterTypeSearchQuery = (() => {
    type TypeName = SearchQuery;
    class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
        read(from: RustBuffer): TypeName {
            return {
                query: FfiConverterString.read(from), 
                limit: FfiConverterUInt32.read(from)
            };
        }
        write(value: TypeName, into: RustBuffer): void {
            FfiConverterString.write(value.query, into);
            FfiConverterUInt32.write(value.limit, into);
        }
        allocationSize(value: TypeName): number {
            return FfiConverterString.allocationSize(value.query) + 
            FfiConverterUInt32.allocationSize(value.limit);
...
export type SearchResponse = {
    total: /*u32*/number,
    results: Array<TableSearchResults>
}

/**
 * Generated factory for {@link SearchResponse} record objects.
 */
export const SearchResponse = (() => {
    const defaults = () => ({
    });
    const create = (() => {
        return uniffiCreateRecord<SearchResponse, ReturnType<typeof defaults>>(defaults);
    })();
    return Object.freeze({
        /**
         * Create a frozen instance of {@link SearchResponse}, with defaults specified
         * in Rust, in the {@link dojo} crate.
         */
        create,
         ...
         * Defaults specified in the {@link dojo} crate.
         */
        defaults: () => Object.freeze(defaults()) as Partial<SearchResponse>,
    });
})();

const FfiConverterTypeSearchResponse = (() => {
    type TypeName = SearchResponse;
    class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
        read(from: RustBuffer): TypeName {
            return {
                total: FfiConverterUInt32.read(from), 
                results: FfiConverterArrayTypeTableSearchResults.read(from)
            };
        }
        write(value: TypeName, into: RustBuffer): void {
            FfiConverterUInt32.write(value.total, into);
            FfiConverterArrayTypeTableSearchResults.write(value.results, into);
        }
        allocationSize(value: TypeName): number {
            return FfiConverterUInt32.allocationSize(value.total) + 
            FfiConverterArrayTypeTableSearchResults.allocationSize(value.results);
...
/**
 * Generated factory for {@link TableSearchResults} record objects.
 */
export const TableSearchResults = (() => {
    const defaults = () => ({
    });
    const create = (() => {
        return uniffiCreateRecord<TableSearchResults, ReturnType<typeof defaults>>(defaults);
    })();
    return Object.freeze({
        /**
         * Create a frozen instance of {@link TableSearchResults}, with defaults specified
         * in Rust, in the {@link dojo} crate.
         */
        create,
         ...
         * Defaults specified in the {@link dojo} crate.
         */
        defaults: () => Object.freeze(defaults()) as Partial<TableSearchResults>,
    });
})();

const FfiConverterTypeTableSearchResults = (() => {
    type TypeName = TableSearchResults;
    class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
        read(from: RustBuffer): TypeName {
            return {
                table: FfiConverterString.read(from), 
                count: FfiConverterUInt32.read(from), 
                matches: FfiConverterArrayTypeSearchMatch.read(from)
            };
        }
        write(value: TypeName, into: RustBuffer): void {
            FfiConverterString.write(value.table, into);
            FfiConverterUInt32.write(value.count, into);
            FfiConverterArrayTypeSearchMatch.write(value.matches, into);
        }
        allocationSize(value: TypeName): number {
            return FfiConverterString.allocationSize(value.table) + 
            FfiConverterUInt32.allocationSize(value.count) + 
            FfiConverterArrayTypeSearchMatch.allocationSize(value.matches);
...
export interface ToriiClientInterface {
    ...
    search(query: SearchQuery)  /*throws*/: SearchResponse;
...
public search(query: SearchQuery): SearchResponse /*throws*/ {
    return FfiConverterTypeSearchResponse.lift(
        uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeDojoError.lift.bind(FfiConverterTypeDojoError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_dojo_uniffi_fn_method_toriiclient_search(uniffiTypeToriiClientObjectFactory.clonePointer(this), 
...
// FfiConverter for Array<SearchField>
const FfiConverterArrayTypeSearchField = new FfiConverterArray(FfiConverterTypeSearchField);


// FfiConverter for Array<SearchMatch>
const FfiConverterArrayTypeSearchMatch = new FfiConverterArray(FfiConverterTypeSearchMatch);
...
// FfiConverter for Array<TableSearchResults>
const FfiConverterArrayTypeTableSearchResults = new FfiConverterArray(FfiConverterTypeTableSearchResults);
...
function uniffiEnsureInitialized() {
    ...
    if (nativeModule().ubrn_uniffi_dojo_uniffi_checksum_method_toriiclient_search() !== 20622) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_dojo_uniffi_checksum_method_toriiclient_search");
    }
...
export default Object.freeze({
  ...
  converters: {
    ...
    FfiConverterTypeSearchMatch,
    FfiConverterTypeSearchQuery,
    FfiConverterTypeSearchResponse,
    FfiConverterTypeSignature,
    FfiConverterTypeSqlField,
    FfiConverterTypeSqlRow,
    FfiConverterTypeSqlValue,
    FfiConverterTypeStruct,
    FfiConverterTypeTableSearchResults,
