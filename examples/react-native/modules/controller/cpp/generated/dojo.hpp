...
class NativeDojo : public jsi::HostObject {
  ...
  protected:
    ...
    jsi::Value cpp_uniffi_dojo_uniffi_fn_method_toriiclient_search(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    ...
    jsi::Value cpp_uniffi_dojo_uniffi_checksum_method_toriiclient_search(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
