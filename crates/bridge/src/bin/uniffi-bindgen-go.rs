...
fn main() {
    ...
    if args.len() > 1 && (args[1] == "--help" || args[1] == "-h") {
        ...
        eprintln!("Arguments:");
        eprintln!(
            "  udl_path              Path to the .udl file (default: crates/uniffi/src/controller.udl)"
        );
        ...
        eprintln!("  {} crates/uniffi/src/controller.udl bindings/go", args[0]);
        eprintln!(
            "  {} crates/uniffi/src/controller.udl bindings/go --config crates/uniffi/uniffi.toml",
            args[0]
        );
        eprintln!();
    ...
    // Default paths
    let default_udl = "crates/uniffi/src/controller.udl";
