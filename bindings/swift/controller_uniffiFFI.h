...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_CLONE_CONTROLLER
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_CLONE_CONTROLLER
uint64_t uniffi_controller_uniffi_fn_clone_controller(uint64_t handle, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_FREE_CONTROLLER
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_FREE_CONTROLLER
void uniffi_controller_uniffi_fn_free_controller(uint64_t handle, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_CONSTRUCTOR_CONTROLLER_FROM_STORAGE
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_CONSTRUCTOR_CONTROLLER_FROM_STORAGE
uint64_t uniffi_controller_uniffi_fn_constructor_controller_from_storage(RustBuffer app_id, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_CONSTRUCTOR_CONTROLLER_NEW
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_CONSTRUCTOR_CONTROLLER_NEW
uint64_t uniffi_controller_uniffi_fn_constructor_controller_new(RustBuffer app_id, RustBuffer username, RustBuffer class_hash, RustBuffer rpc_url, uint64_t owner, RustBuffer address, RustBuffer chain_id, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_CONSTRUCTOR_CONTROLLER_NEW_HEADLESS
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_CONSTRUCTOR_CONTROLLER_NEW_HEADLESS
uint64_t uniffi_controller_uniffi_fn_constructor_controller_new_headless(RustBuffer app_id, RustBuffer username, RustBuffer class_hash, RustBuffer rpc_url, uint64_t owner, RustBuffer chain_id, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_ADDRESS
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_ADDRESS
RustBuffer uniffi_controller_uniffi_fn_method_controller_address(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_APP_ID
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_APP_ID
RustBuffer uniffi_controller_uniffi_fn_method_controller_app_id(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_CHAIN_ID
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_CHAIN_ID
RustBuffer uniffi_controller_uniffi_fn_method_controller_chain_id(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_CLEAR_LAST_ERROR
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_CLEAR_LAST_ERROR
void uniffi_controller_uniffi_fn_method_controller_clear_last_error(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_DELEGATE_ACCOUNT
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_DELEGATE_ACCOUNT
RustBuffer uniffi_controller_uniffi_fn_method_controller_delegate_account(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_DISCONNECT
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_DISCONNECT
void uniffi_controller_uniffi_fn_method_controller_disconnect(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_ERROR_MESSAGE
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_ERROR_MESSAGE
RustBuffer uniffi_controller_uniffi_fn_method_controller_error_message(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_EXECUTE
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_EXECUTE
RustBuffer uniffi_controller_uniffi_fn_method_controller_execute(uint64_t ptr, RustBuffer calls, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_SIGNUP
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_SIGNUP
void uniffi_controller_uniffi_fn_method_controller_signup(uint64_t ptr, RustBuffer signer_type, RustBuffer session_expiration, RustBuffer cartridge_api_url, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_SWITCH_CHAIN
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_SWITCH_CHAIN
void uniffi_controller_uniffi_fn_method_controller_switch_chain(uint64_t ptr, RustBuffer rpc_url, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_TRANSFER
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_TRANSFER
RustBuffer uniffi_controller_uniffi_fn_method_controller_transfer(uint64_t ptr, RustBuffer recipient, RustBuffer amount, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_USERNAME
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_METHOD_CONTROLLER_USERNAME
RustBuffer uniffi_controller_uniffi_fn_method_controller_username(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_ADDRESS
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_ADDRESS
uint16_t uniffi_controller_uniffi_checksum_method_controller_address(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_APP_ID
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_APP_ID
uint16_t uniffi_controller_uniffi_checksum_method_controller_app_id(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_CHAIN_ID
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_CHAIN_ID
uint16_t uniffi_controller_uniffi_checksum_method_controller_chain_id(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_CLEAR_LAST_ERROR
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_CLEAR_LAST_ERROR
uint16_t uniffi_controller_uniffi_checksum_method_controller_clear_last_error(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_DELEGATE_ACCOUNT
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_DELEGATE_ACCOUNT
uint16_t uniffi_controller_uniffi_checksum_method_controller_delegate_account(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_DISCONNECT
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_DISCONNECT
uint16_t uniffi_controller_uniffi_checksum_method_controller_disconnect(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_ERROR_MESSAGE
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_ERROR_MESSAGE
uint16_t uniffi_controller_uniffi_checksum_method_controller_error_message(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_EXECUTE
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_EXECUTE
uint16_t uniffi_controller_uniffi_checksum_method_controller_execute(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_SIGNUP
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_SIGNUP
uint16_t uniffi_controller_uniffi_checksum_method_controller_signup(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_SWITCH_CHAIN
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_SWITCH_CHAIN
uint16_t uniffi_controller_uniffi_checksum_method_controller_switch_chain(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_TRANSFER
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_TRANSFER
uint16_t uniffi_controller_uniffi_checksum_method_controller_transfer(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_USERNAME
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_METHOD_CONTROLLER_USERNAME
uint16_t uniffi_controller_uniffi_checksum_method_controller_username(void
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_CONSTRUCTOR_CONTROLLER_NEW
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_CONSTRUCTOR_CONTROLLER_NEW
uint16_t uniffi_controller_uniffi_checksum_constructor_controller_new(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_CONSTRUCTOR_CONTROLLER_NEW_HEADLESS
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_CONSTRUCTOR_CONTROLLER_NEW_HEADLESS
uint16_t uniffi_controller_uniffi_checksum_constructor_controller_new_headless(void
