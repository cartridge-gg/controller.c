...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_FUNC_CREATE_SESSION_REGISTRATION_URL
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_FUNC_CREATE_SESSION_REGISTRATION_URL
RustBuffer uniffi_controller_uniffi_fn_func_create_session_registration_url(RustBuffer private_key, RustBuffer policies, RustBuffer rpc_url, RustBuffer preset, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_FUNC_CREATE_SESSION_REGISTRATION_URL_WITH_URLS
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_FN_FUNC_CREATE_SESSION_REGISTRATION_URL_WITH_URLS
RustBuffer uniffi_controller_uniffi_fn_func_create_session_registration_url_with_urls(RustBuffer private_key, RustBuffer policies, RustBuffer rpc_url, RustBuffer keychain_url, RustBuffer cartridge_api_url, RustBuffer preset, RustCallStatus *_Nonnull out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_FUNC_CREATE_SESSION_REGISTRATION_URL
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_FUNC_CREATE_SESSION_REGISTRATION_URL
uint16_t uniffi_controller_uniffi_checksum_func_create_session_registration_url(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_FUNC_CREATE_SESSION_REGISTRATION_URL_WITH_URLS
#define UNIFFI_FFIDEF_UNIFFI_CONTROLLER_UNIFFI_CHECKSUM_FUNC_CREATE_SESSION_REGISTRATION_URL_WITH_URLS
uint16_t uniffi_controller_uniffi_checksum_func_create_session_registration_url_with_urls(void
